...
function Angry({ className, width = 28, height = 28, ...props }: EmojiProps) {
    return (
        <svg
            className={className}
            width={width}
        ...
        >
            ...
            <defs>
                ...
                >
                    ...
                    ></feColorMatrix>
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_3766_16490"></feBlend>
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                ...
                >
                    ...
                    ></feColorMatrix>
                    <feBlend mode="normal" in2="shape" result="effect1_innerShadow_3766_16490"></feBlend>
                </filter>
                <filter
