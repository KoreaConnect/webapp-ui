        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-border hover:border-primary/30 transition-all cursor-pointer group hover:shadow-md">
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col lg:flex-row gap-5">
                    ...
                    {ride.description && (
                        <div className="flex-1 bg-zinc-50 dark:bg-zinc-800/50 rounded-2xl p-4 border border-transparent group-hover:border-zinc-100 dark:group-hover:border-zinc-800 transition-all">
                ...
                {/* {!isOwner && ( */}
                <div
                    className="flex items-center justify-end  shrink-0 border-t md:border-t-0 md:border-l border-border pt-4 md:pt-0 md:pl-6"
